...
const propTypes = {
  ...
  /**
   *  A custom image to be used as the marker's background image of icon.
   */
  imageBack: PropTypes.any,
...
class MapMarker extends React.Component {
  ...
  render() {
    ...
    if (this.props.imageBack) {
      imageBack = resolveAssetSource(this.props.imageBack) || {};
      imageBack = imageBack.uri || this.props.imageBack;
    }
